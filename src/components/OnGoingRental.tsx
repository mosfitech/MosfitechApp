...
export default function OnGoingRental(props: any) {
  return (
    <div className="">
      ...
      <div className="text-gray-50 flex justify-between  items-center mt-10 px-10 gap-1 ">
      ...
      >
        <p className="bg-mobarang py-3 px-16 rounded-3xl font-bold leading-relaxed text-gray-50 inline-block align-middle">
          Selesai
        </p>
      </div>
    </div>
