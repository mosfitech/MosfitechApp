...
export default function BottomNavbar({ setPages }) {
        ...
        <div className="flex h-full max-w-lg justify-between px-8 py-1">
          ...
          <div className="flex items-center justify-center">
            <button
              ...
              type="button"
              className="inline-flex items-center justify-center w-16 h-16 font-medium bg-primary-600 rounded-full hover:bg-primary-400 group focus:ring-4 focus:ring-blue-300 focus:outline-none dark:focus:ring-blue-800"
            >
              <svg
                width="39"
                height="39"
